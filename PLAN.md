...
- [x] Add deterministic ordered fallback only for the allowlisted eligible pre-mutation classes, with a persisted decision boundary, bounded non-cycling routes, and queued-route restart recovery.
